  ...
  return async function (moduleArg = {}) {
    ...
    (() => {
      ...
      async function loadPackage(metadata) {
        ...
        var PACKAGE_NAME = "/home/claude/web3sx/3sx/web/dist/3sx.data";
        var REMOTE_PACKAGE_BASE = "3sx.data";
        ...
        async function runWithFS(Module) {
          ...
          async function processPackageData(arrayBuffer) {
            ...
            Module.removeRunDependency("datafile_/home/claude/web3sx/3sx/web/dist/3sx.data");
          }
          Module.addRunDependency("datafile_/home/claude/web3sx/3sx/web/dist/3sx.data");
      ...
      loadPackage({
        files: [{
          filename: "/assets/glyphs.bmp",
          start: 0,
          end: 189578
        }, {
          filename: "/assets/xbox_buttons.bmp",
          start: 189578,
          end: 222484
        }],
        remote_package_size: 222484
      });
    })();
    var arguments_ = [];
    ...
    var _emscripten_get_main_loop_timing = (mode, value) => {
      if (mode) {
        HEAP32[mode >> 2] = MainLoop.timingMode;
      }
      if (value) {
    ...
    var registerOrientationChangeEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
      ...
      var orientationChangeEventHandlerFunc = e => {
        ...
        if (((a1, a2, a3) => dynCall_iiii(callbackfunc, a1, a2, a3))(eventTypeId, orientationChangeEvent, userData)) {
          e.preventDefault();
        }
      };
      var eventHandler = {
    ...
    var ASM_CONSTS = {
      ...
      1040338: () => Module.SDL3.audioContext.sampleRate,
      1040389: ($0, $1, $2, $3) => {
        var SDL3 = Module.SDL3;
      ...
      1045894: () => navigator.mediaDevices === undefined ? 0 : 1,
      1045953: ($0, $1, $2, $3, $4) => {
        const device = $0;
        const w = $1;
        const h = $2;
      ...
      1054585: () => Module.SDL3.mouse_x,
      1054623: () => Module.SDL3.mouse_y,
      1054661: $0 => Module.SDL3.mouse_buttons[$0],
      1054709: $0 => {
        var data = $0;
      ...
      1057080: () => document.body.clientWidth,
      1057118: () => document.body.clientHeight,
      1057157: () => window.innerWidth,
      1057187: () => window.innerHeight,
      1057218: () => window.outerWidth,
      1057248: () => window.outerHeight,
      1057279: () => window.pageXOffset,
      1057310: () => window.pageYOffset,
      1057341: ($0, $1) => {
      ...
      1063122: () => window.innerWidth,
      1063152: () => window.innerHeight,
      1063183: $0 => {
      ...
      1063859: () => window.innerWidth,
      1063889: () => window.innerHeight,
      1063920: $0 => {
    ...
    var _CallSDLEmscriptenMainFunction;
    ...
    function assignWasmExports(wasmExports) {
      ...
      dynCall_viiifi = dynCalls.viiifi = wasmExports.dynCall_viiifi;
...
if (typeof exports === "object" && typeof module === "object") {
  module.exports = create3SX;
  module.exports.default = create3SX;
